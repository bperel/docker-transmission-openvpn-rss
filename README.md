# Transmission with WebUI, RSS support and OpenVPN

_This Docker image inherits from the great [haugene/transmission-openvpn](https://github.com/haugene/docker-transmission-openvpn) Docker image and adds support for RSS-based subscriptions. Most of the instructions hereunder were hence copied from the original repository._


Docker container which runs Transmission torrent client with RSS support and WebUI while connecting to OpenVPN.
...
$ docker run --privileged  -d \
              ...
              -e "RSS_URL=http://showrss.info/user/xxxxx.rss" \
              -p 9091:9091 \
              bperel/transmission-openvpn-rss
```
...
|`RSS_URL`|The RSS feed's URL |`RSS_URL=http://showrss.info/user/xxxxx.rss`|
...
ExecStartPre=/usr/bin/docker pull bperel/transmission-openvpn-rss
